...
Public Class Form1
    ...
    Private Sub AboutThisProgramToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AboutThisProgramToolStripMenuItem.Click
        MsgBox("This program was written by S.R.Mckiernan for Bangor University (2023)", vbInformation, "About This Program")
    End Sub
    ...
    Private Sub StartNewSubjectToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles StartNewSubjectToolStripMenuItem.Click, TrainingStartToolStripMenuItem.Click

        'Has "Start Training" or "Start Trials" been clicked? 
        If sender.Name.ToString = "TrainingStartToolStripMenuItem" Then
            Training = True
            subjectName = "trainingSubject"
        Else
            Training = False
            subjectName = "Subject"
        End If
        ...
        Else
            If Training = True Then 'Start training/real trials by sending message to black box
                SerialPort1.Write("AYTR" & Chr(13))
            Else
                SerialPort1.Write("AYNT" & Chr(13))
            End If
        End If
